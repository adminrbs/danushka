...
const DatatableFixedColumns = function () {
    ...
    const _componentDatatableFixedColumns = function () {
        ...
        var table = $('.datatable-fixed-both-vehicle').DataTable({
            columnDefs: [
                {
                    orderable: false,
                    targets: 2,
...
$(document).on('click', '.vehicaleEdit', function (e) {
    ...
    $.ajax({
        url: '/getVehicaleEdit/' + vehicle_id,
        method: 'get',
        data: {
            //id: id,
            _token: '{{ csrf_token() }}'
