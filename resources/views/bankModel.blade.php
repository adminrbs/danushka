            ...
            <div class="modal-body">
                ...
                <div class="modal-body p-4 bg-white">
                    <form id="" class="needs-validation" novalidate>
                        <div class="row">
                            <div class="col-lg">
                                <label for="fname">Code<span class="text-danger">*</span></label>
                                ...
                                <label for="fname">Bank Name<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col-lg">
                                ...
                                <input type="text" name="branchCode" id="txtbranchCode" class="form-control" maxlength="3"
                                    ...
                                    <label for="fname">Bank Branch Name<span class="text-danger">*</span></label>
