                    ...
                    <div class="card-body border-top">
                        <div class="form-row">
                            <div class="col-md-4 mb-2">
                                <label class="form-label col-form-label-sm">Customer ID:</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-2">
                                <label class="form-label col-form-label-sm">Customer Name:</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-2">
                                <label class="form-label col-form-label-sm">Credit Limit:</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-2">
                                <label class="form-label col-form-label-sm">Customer Address:</label>
