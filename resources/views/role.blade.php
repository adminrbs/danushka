                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header" id="headingDesignation">
                            <h5 class="mb-0">
                                <button class="btn btn-link" data-bs-toggle="collapse" href="#role" role="button"
                                    aria-expanded="false" aria-controls="collapseExample" onclick="roleTable()">
                                    <i class="bi bi-gear" style="margin-right: 5px"></i> Role
                                </button>
                            </h5>

                        </div>
                        <div id="role" class="collapse" aria-labelledby="headingDesignation"
                        ...
                        <div class="card-header" id="headingDesignation">
                            <h5 class="mb-0">
                                <button class="btn btn-link" data-bs-toggle="collapse" href="#rolelist" role="button" aria-expanded="false" aria-controls="collapseExample" onclick="rolListTable()">
                                    <i class="bi bi-gear" style="margin-right: 5px"></i> Role List
                                </button>
                            </h5>
...
@section('scripts')
    ...
    <script src="{{ URL::asset('assets/js/role.js') }}?random=<?php echo uniqid(); ?>"></script>
    <script src="{{ URL::asset('assets/js/rolelist.js') }}?random=<?php echo uniqid(); ?>"></script>
