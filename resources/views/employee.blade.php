                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div>
                                                    <input class="form-control form-control-sm validate" type="text"
                                                        id="txtRepotno" name="numbers" required>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div>
                                                    <input class="form-control form-control-sm validate" type="date"
                                                        id="txtDateofjoined" name="dateofjoined" required>
                                                ...
                                                <div>
                                                    <input class="form-control form-control-sm validate " type="date"
                                                        id="txtDateofresign" name="dateofresign" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="mb-1">
                                                ...
                                                <div>
                                                    <select class="form-control  form-control-sm" required id="cmbStatus" name="status">
                                                        <optgroup >
