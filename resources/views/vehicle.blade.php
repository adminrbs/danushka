...
<div class="content">
    ...
    <div class="modal fade mt-5" id="modalVehicle" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <form id="" class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-lg">
                                    <div class="row mb-1">
                                        <div class="col-md-12">
                                            <label for="cmbcustomer">Vehicle No<span class="text-danger">*</span></label>
                                            <input type="text" id="txtvehicleNo" class="form-control validate" required>
                                            <span class="text-danger font-weight-bold "></span>
                                        </div>
                                        <div class="col-md-12">
                                            <label for="txtEmailcustomer">Vehicle Name</label>
                                        ...
                                        <div class="col-md-12">
                                            <label for="txtMobilphonecustomer">Description</label>
                                            <input type="text" id="txtDescription" class="form-control validate">

                                            <span class="text-danger font-weight-bold "></span>
                                        </div>
                                        <div class="col-md-12">
                                            <label for="txtPasswordcustomer">Type<span class="text-danger">*</span></label>
                                            <select id="cmbVehicleType" class="form-control form-control-sm "
                                        ...
                                        <div class="col-md-12">
                                            <label class="col-form-label mb-0">Remarks</label>
        ...
        @section('scripts')
            ...
            <script src="{{ URL::asset('assets/js/vehicle.js') }}?random=<?php echo uniqid(); ?>"></script>
